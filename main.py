...
WTTR_LOCATION = "Dongcheng,Beijing"            

# 4. 屏幕显示文字
# 天气页面左上角的自定义标题，你可以改成 "北京市 | 我的温馨小窝" 等等
CITY_DISPLAY_NAME = "北京市"      
...
def get_solar_term(year, month, day):
    # 节气由 lunar_python 按公历天文精确计算，长期有效
    # （不再依赖写死的节气表，彻底解决“过期炸弹”问题）
    try:
        name = Solar.fromYmd(year, month, day).getLunar().getJieQi()
